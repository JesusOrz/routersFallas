$(document).ready(function () {
    $("#submitBtn").on("click", function () {
        ...
        $.ajax({
            ...
            <div class="alert ${colorClass}">
                <strong>Análisis: ${item.type} — Severidad: ${
                        item.resultado.severidad?.toUpperCase() || "N/A"
                    }</strong><br>
        ...
        `;
                    ...
                    if (
                        ...
                        recomendacionesHTML += `<div class="mb-2"><strong>${item.type}</strong><ul>`;
    ...
    $("#descargarpdf").on("click", function () {
        ...
        const recomendaciones = $("#recomendaciones .mb-2")
            .map(function () {
